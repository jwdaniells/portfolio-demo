// user_config.js — auto-loaded by index.html and retirement.html
// Edit user_config.json to customise your instance; this file is generated from it.
// To regenerate: python3 -c "import json,sys; d=json.load(open('user_config.json')); print('window.USER_CONFIG = ' + json.dumps(d, indent=2) + ';')" > user_config.js

window.USER_CONFIG = {
  "_comment": "Portfolio Tracker — user configuration. Edit this file to personalise your instance.",
  ...
  "goal": {
    "target":         1400000,
    "baseline":       857270,
    "baselineDate":   "2026-02-25",
    "monthlyContrib": 2010.67,
    "rateRequired":   0.0790,
    "rateProjected":  0.115,
    "rateBear":       0.06,
    "rateBull":       0.17
  ...
  "retirement": {
    ...
    "dbPensions": [
      { "person": "person1", "name": "Atkins",      "annual": 5000, "startAge": 65, "indexed": false },
      { "person": "person1", "name": "Pfizer",      "annual": 2500, "startAge": 65, "indexed": false },
      { "person": "person2", "name": "Disney",      "annual": 1237, "startAge": 65, "indexed": false },
      { "person": "person2", "name": "Nippon Life", "annual": 135,  "startAge": 65, "indexed": false }
    ],
    ...
    "mortgageNow":               350000,
    "mortgageRepaymentPortion":  100000,
