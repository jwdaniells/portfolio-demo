  ...
  return (
    <div style={S.wrap}>
      <nav style={S.nav}>
        ...
        <a href="./config.html" style={{color:"#6a7d8f",textDecoration:"none",fontSize:10,letterSpacing:"0.1em",padding:"14px 12px",borderBottom:"2px solid transparent",display:"flex",alignItems:"center",gap:4}} onMouseEnter={e=>e.currentTarget.style.color="#c9a84c"} onMouseLeave={e=>e.currentTarget.style.color="#6a7d8f"}>⚙ CONFIG</a>
